...
🌱 Currently exploring **AI/ML, LLMs, databases, system design and modern software development**.
...
An educational AI project focused on developing a **healthcare conversational assistant**.
...
`Python` `AI/ML` `LLM` `MongoDB` `JSONL` `PyTorch` `Ollama` `Hugging Face`

> ⚠️ This project is for educational/research purposes and does not replace professional medical advice.
...
**Web Development • Database • Automation**

Exploring software solutions for agricultural businesses, machinery sales, service management and digital workflows.
...
║  📊  Master Data Science                                     ║
║                                                              ║
║  🗄️  Become Strong in Database Architecture                  ║
║                                                              ║
